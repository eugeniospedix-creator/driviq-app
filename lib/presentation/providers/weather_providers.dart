...
import '../../services/composite_weather_mood_service.dart';
import '../../services/interfaces/weather_mood_service.dart';
import '../../services/live_weather_mood_service.dart';

final liveWeatherMoodServiceProvider = Provider<LiveWeatherMoodService>((ref) {
  return LiveWeatherMoodService();
});

final weatherMoodServiceProvider = Provider<WeatherMoodService>((ref) {
  final override = ref.watch(weatherMoodOverrideProvider);
  return CompositeWeatherMoodService(
    live: ref.watch(liveWeatherMoodServiceProvider),
    debugMood: override,
  );
});
